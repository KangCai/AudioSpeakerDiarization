 ...
 *
 */
package com.audioprocessingbox;
...
import com.audioprocessingbox.distances.DistanceCalculator;
import com.audioprocessingbox.distances.EuclideanDistanceCalculator;
...
public class Recognito<K> {
    ...
    /**
     * Kang defined this new function at 2016.3.17
     */
    public ConcurrentHashMap<K, VoicePrint> getStore () {
    	return store;
    }
